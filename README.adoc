= SAÉ 2.02 (Rapport : link:rapport/Rapport.adoc[ici], Analyse : link:analyse/Analyses.pdf[ici]) +
:icons: font
:numbered:
:toc: left
:toc-title: Sommaire
...
| 2    | link:/src/main/java/eraser/Eraser2.java[ici] | Java     | Efficacité
| 3    | link:/src/main/java/eraser/Eraser2.java[ici] | Java     | Sobriété numérique 
| 4    | link:/solution.py[ici]                       | Python   | Simplicité   
| 5    | link:/solution2.py[ici]                      | Python   | Efficacité 
| 6    | link:/solution.c[ici]                        | C        | Efficacité
| 7    | link:/solution.c[ici]                        | C        | Simplicité
|==========================================================================
